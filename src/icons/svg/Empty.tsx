export type EmptyPageSvgProps = Omit<JSX.IntrinsicElements['svg'], 'viewBox' | 'fill'>;

export const EmptyPageSvg = (props: EmptyPageSvgProps): JSX.Element => {
  const { width = 212, height = 174 } = props;
  return (
    <svg width={width} height={height} viewBox="0 0 1062 870" fill="none" xmlns="http://www.w3.org/2000/svg">
      <g id="No Results">
        <g id="circle">
          <path id="Stroke 1" d="M34.8164 399V408" stroke="#D2D8DF" strokeWidth="2.921" strokeLinecap="round" />
          <g id="Group 8">
            <path
              id="Stroke 2"
              ...
              strokeLinecap="round"
            />
            <path id="Stroke 4" d="M6 424.028H16.3989" stroke="#D2D8DF" strokeWidth="2.921" strokeLinecap="round" />
            <path
              id="Stroke 6"
          ...
          <path id="Stroke 9" d="M34.8164 447V438" stroke="#D2D8DF" strokeWidth="2.921" strokeLinecap="round" />
          <path
            id="Stroke 10"
            ...
            strokeLinecap="round"
          />
          <path id="Stroke 11" d="M61.8164 426H52.8164" stroke="#D2D8DF" strokeWidth="2.921" strokeLinecap="round" />
          <path
            id="Stroke 12"
